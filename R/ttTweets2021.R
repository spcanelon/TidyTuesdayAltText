...
#'   \item{TweetDate}{<dttm> Date and time the tweet was posted. Ranges from January 1, 2021 to April 4, 2021.}
#'   \item{Year}{<fct> Year the tweet was posted. Includes only 2021.}
