...
library(tidyverse)
source("data-raw/makeDataDictionary.R")
```
...
```{r echo=FALSE}
makeDataDictionary(AltTextSubset)
...
```{r echo=FALSE}
makeDataDictionary(ttTweets2021)
...
```{r echo=FALSE}
makeDataDictionary(ttTweets2020)
...
```{r echo=FALSE}
makeDataDictionary(ttTweets2019)
...
```{r echo=FALSE}
makeDataDictionary(ttTweets2018)
